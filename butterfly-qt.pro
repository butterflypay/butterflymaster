...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.butterflycoin
    BOOST_LIB_SUFFIX=-mt
    BOOST_INCLUDE_PATH=/usr/local/Cellar/boost/1_55_0/include
...
build_win32 {
    ...
    OPENSSL_INCLUDE_PATH=c:/deps/openssl_1.0.1g/include
    OPENSSL_LIB_PATH=c:/deps/openssl_1.0.1g/lib/
...
contains(BUTTERFLY_NEED_QT_PLUGINS, 1) {
    DEFINES += BUTTERFLY_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/butterflygui.h \
    src/qt/butterflybridge.h \
...
SOURCES += \
    ...
    src/qt/butterflygui.cpp \
    src/qt/butterfly.cpp \
    src/qt/butterflybridge.cpp \
...
macx:ICON = src/qt/res/icons/butterfly.icns
macx:TARGET = "Butterfly"
