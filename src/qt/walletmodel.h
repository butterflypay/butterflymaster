...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        SCR_AmountWithFeeExceedsButterflyBalance,
        SCR_Error,
        SCR_ErrorWithMsg,
        Aborted
    };
    ...
    qint64 getButterflyBalance() const;
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 butterflyBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
