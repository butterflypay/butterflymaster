#ifndef BUTTERFLYBRIDGE_H
#define BUTTERFLYBRIDGE_H
...
class ButterflyBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit ButterflyBridge(ButterflyGUI *window, QObject *parent = 0);
    ~ButterflyBridge();
