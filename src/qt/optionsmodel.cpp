...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::BFC).toInt();
    ...
    fAutoRedeemButterfly = settings.value("fAutoRedeemButterfly", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemButterfly:
            return fAutoRedeemButterfly;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemButterfly: return "AutoRedeemButterfly";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::BFC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemButterfly: {
            fAutoRedeemButterfly = value.toBool();
            settings.setValue("fAutoRedeemButterfly", fAutoRedeemButterfly);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemButterfly() { return fAutoRedeemButterfly; }
